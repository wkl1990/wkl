...
#theGEDFilePath = paste(myPath,thefile, sep="/")
#theExpDataFilePath = paste(myPath,thedatafile, sep="/")
...
axis(1, at = bp, labels = effectsNames, xlab = "Effects", cex.axis = 0.8, las=2)
